...
const (
	Processor_Process_FullMethodName = "/msg.Processor/Process"
)
...
func (c *processorClient) Process(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
...
func (UnimplementedProcessorServer) Process(context.Context, *Request) (*Response, error) {
...
func _Processor_Process_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProcessorServer).Process(ctx, req.(*Request))
	}
